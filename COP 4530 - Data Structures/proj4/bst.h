...
class BST {
   ...
   public:
	...
	struct BSTNode {
	    ...
	    BSTNode(T&& theElement, BSTNode *lt, BSTNode *rt) : element{std::move(theElement)}, left{lt}, right{rt} {}
	...
	BSTNode * findMin(BSTNode *t) const;				// find the smallest element in the subtree
	BSTNode * findMax(BSTNode *t) const;				// find the smallest element in the subtree
